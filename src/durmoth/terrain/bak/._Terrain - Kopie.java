...
public class $Terrain {
    ...
    public Terrain(int tile_size, int xOffset, int  yOffset, int s, AssetManager assetMan){
        size = tile_size;
        xOff = xOffset;
        yOff = yOffset;
        seed = s;
    ...
    public Node getTerrainQuad(){
        ...
        Material terr_mat = assetManager.loadMaterial("Materials/Terrain.j3m");
        ...
        for(RawVegetationObject o : rawVegList){
            if(o.getType()==VegetationObjectType.GRASS){
                Spatial grass = assetManager.loadModel("Models/plant/grass.j3o");
                Material mat = assetManager.loadMaterial("Materials/HighGrass.j3m");
            ...
            if(o.getType()==VegetationObjectType.TREE1){
                Spatial grass = assetManager.loadModel("Models/tree/tree1.j3o");
                Material wood = assetManager.loadMaterial("Materials/Wood.j3m");
            ...
            if(o.getType()==VegetationObjectType.TREE2){
                Spatial grass = assetManager.loadModel("Models/raw/tree3.j3o");
                Material wood = assetManager.loadMaterial("Materials/Tree3.j3m");
                grass.setMaterial(wood);
                //TangentBinormalGenerator.generate(grass);
                //grass.setMaterial(wood);
                grass.setQueueBucket(Bucket.Translucent);
            ...
            if(o.getType()==VegetationObjectType.LILYPAD){
                Spatial grass = assetManager.loadModel("Models/plant/lilypad.j3o");
                Material mat = assetManager.loadMaterial("Materials/Lilypad.j3m");
                grass.setMaterial(mat);
                grass.setQueueBucket(Bucket.Translucent);
                float x = o.getPosition().x*xScale;
                float z = o.getPosition().y*yScale;
            ...
            if(o.getType()==VegetationObjectType.SWAMP_FIRE){
                ...
                Material fireMat = assetManager.loadMaterial("Materials/Fire.j3m");
