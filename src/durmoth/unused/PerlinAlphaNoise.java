...
public class PerlinAlphaNoise {
    ...
    */
   public PerlinAlphaNoise(int width, int height, Random rand) {
       random = rand;
      this.width = width;
      this.height = height;
   ...
   public float noise(float x, float y) {
      ...
      h *= 0.01; // Multiply here so adjust contrast.
   ...
   public static BufferedImage getImage() {
      ...
      int size1 = 30; // Perlin's noise map.
      PerlinSubNoise noise1 = new PerlinSubNoise(size1, size1 , random);
      ...
      for (int y = 0; y < height; y++) {
         for (int x = 0; x < width; x++) {
            ...
            Color color = new Color(col, col2, col3); // java.AWT color to get RGB from.
